<template>
  <div
    class="flex items-center gap-3 py-2.5 px-3 rounded-xl hover:bg-[#F8FAFC] transition-colors"
  >
    <!-- Type icon -->
    <div
      :class="[
    ...
    <div class="text-right shrink-0">
      <p
        :class="[
          ...
          transaction.type === 'deposit' ? 'text-[#059669]' : 'text-[#DC2626]',
        ]"
      >
    ...
    <div class="shrink-0 flex items-center gap-1">
      ...
      <template v-if="!isEditing">
        <button
          @click="startEdit"
          class="p-1.5 rounded-lg hover:bg-[#E2E8F0] text-[#94A3B8] hover:text-[#1E293B] transition-colors"
          title="Edit note"
        >
          <svg
            class="w-3.5 h-3.5"
